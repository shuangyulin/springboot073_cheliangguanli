    ...
    >
      ...
      <el-col :span="12">
        ...
        <div v-else>
          ...
          <el-row>
            <el-col :span="24">
              <el-form-item v-if="type!='info'"  label="保养内容" prop="baoyangneirong">
                <editor 
              ...
              <div v-else>
                <el-form-item v-if="ruleForm.baoyangneirong" label="保养内容" prop="baoyangneirong">
                    <span v-html="ruleForm.baoyangneirong"></span>
                </el-form-item>
              </div>
            </el-col>
          </el-row>
...
export default {
  ...
  methods: {
	...
	this.ruleForm.baoyangneirong = this.ruleForm.baoyangneirong.replace(reg,'../../../springbootg2g8t/upload');
        } else {
          this.$message.error(data.msg);
        }
      });
