  ...
  <div class="addEdit-block">
    ...
    >
      ...
      <el-col :span="12">
        ...
        <div v-else>
          <el-form-item class="input"v-if="ruleForm.cheliangmingcheng" label="车辆名称" prop="cheliangmingcheng">
      ...
      <el-col :span="12">
        <el-form-item class="date" v-if="type!='info'" label="发生日期" prop="fashengriqi">
            <el-date-picker
                format="yyyy 年 MM 月 dd 日"
                value-format="yyyy-MM-dd"
                v-model="ruleForm.fashengriqi" 
                type="date"
                placeholder="发生日期">
            </el-date-picker> 
        </el-form-item>
        <div v-else>
          <el-form-item class="input" v-if="ruleForm.fashengriqi" label="发生日期" prop="fashengriqi">
              <el-input v-model="ruleForm.fashengriqi" 
                placeholder="发生日期" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="事故地点" prop="shigudidian">
          <el-input v-model="ruleForm.shigudidian" 
              placeholder="事故地点" clearable  :readonly="ro.shigudidian"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="事故地点" prop="shigudidian">
              <el-input v-model="ruleForm.shigudidian" 
                placeholder="事故地点" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="责任归属" prop="zerenguishu">
          <el-input v-model="ruleForm.zerenguishu" 
              placeholder="责任归属" clearable  :readonly="ro.zerenguishu"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="责任归属" prop="zerenguishu">
              <el-input v-model="ruleForm.zerenguishu" 
                placeholder="责任归属" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
      ...
      <el-col :span="12">
        ...
        <div v-else>
          ...
          <el-row>
            <el-col :span="24">
              <el-form-item class="textarea" v-if="type!='info'" label="事故原因" prop="shiguyuanyin">
                <el-input
                  style="min-width: 200px; max-width: 600px;"
                  type="textarea"
                  :rows="8"
                  placeholder="事故原因"
                  v-model="ruleForm.shiguyuanyin" >
                </el-input>
              </el-form-item>
              <div v-else>
                <el-form-item v-if="ruleForm.shiguyuanyin" label="事故原因" prop="shiguyuanyin">
                    <span>{{ruleForm.shiguyuanyin}}</span>
                </el-form-item>
              </div>
            </el-col>
          </el-row>
          <el-row>
            <el-col :span="24">
              <el-form-item v-if="type!='info'"  label="细节处理" prop="xijiechuli">
                <editor 
                    style="min-width: 200px; max-width: 600px;"
                    v-model="ruleForm.xijiechuli" 
                    class="editor" 
                    action="file/upload">
                </editor>
              </el-form-item>
              <div v-else>
                <el-form-item v-if="ruleForm.xijiechuli" label="细节处理" prop="xijiechuli">
                    <span v-html="ruleForm.xijiechuli"></span>
                </el-form-item>
              </div>
            </el-col>
          </el-row>
...
export default {
  ...
  methods: {
    ...
    init(id,type) {
      ...
      if(this.type=='info'||this.type=='else'){
	    ...
	    this.ro.chepaihao = true;
          ...
          if(o=='fashengriqi'){
            this.ruleForm.fashengriqi = obj[o];
	    this.ro.fashengriqi = true;
            continue;
          }
          if(o=='shigudidian'){
	    ...
	    this.ro.shigudidian = true;
          ...
          if(o=='zerenguishu'){
            this.ruleForm.zerenguishu = obj[o];
	    this.ro.zerenguishu = true;
            continue;
          }
          if(o=='shiguyuanyin'){
	    ...
	    this.ro.shiguyuanyin = true;
          ...
          if(o=='xijiechuli'){
            this.ruleForm.xijiechuli = obj[o];
	    this.ro.xijiechuli = true;
            continue;
          }
          if(o=='dengjishijian'){
    ...
    cheliangmingchengChange () {
      this.$http({
        url: `follow/cheliangxinxi/cheliangmingcheng?columnValue=`+ this.ruleForm.cheliangmingcheng,
        method: "get"
      }).then(({ data }) => {
        if (data && data.code === 0) {
              if(data.data.pinpai){
	...
	this.ruleForm.xijiechuli = this.ruleForm.xijiechuli.replace(reg,'../../../springbootg2g8t/upload');
        } else {
          this.$message.error(data.msg);
        }
      });
